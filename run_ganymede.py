...
layers_ganymede = [
    ...
    {"name": "Ocean", "mass": M_ganymede*0.93, "eos": "constant_density","constant_rho":1.,"T_struct":"isentrope"},
...
ganymede.integrate_structure_iterate(max_iter=100,rtol=1e-5,debug=False,P_surf=1e6,T_surf=110.,from_scratch=True,save=True)
