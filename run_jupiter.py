...
"""
layers_jupiter = [
 #   {"name": "Noyau", "mass": Mplanet/100, "eos": "mixture","nbelem":2,"files":["Chabrier2019-H.csv","Chabrier2019-He.csv"],"mass_fractions":[0.73,0.27],"T_struct":"isentrope"},
 #   {"name": "Manteau", "mass": Mplanet/10, "eos": "mixture","nbelem":2,"files":["Chabrier2019-H.csv","Chabrier2019-He.csv"],"mass_fractions":[0.73,0.27],"T_struct":"isentrope"},
...
"""
layers_jupiter = [
    {"name": "Manteau", "mass": Mplanet*0.04, "eos": "hm1989_rocks","roches": True,"T_struct":"isotherm"},
    {"name": "Envelope", "mass": Mplanet, "eos": "mixture","nbelem":2,"files":["Chabrier2019-H.csv","Chabrier2019-He.csv"],"mass_fractions":[0.73,0.27],"T_struct":"isentrope"},
]

t0 = time.time()
jupiter = SatelliteModel("Jupiter", Mplanet, layers_jupiter, nlayers=4000, distribution_type='erf')
jupiter.integrate_structure_iterate(max_iter=100,rtol=1e-5,debug=False,P_surf=1e6,T_surf=165.,from_scratch=True,save=False)
R_cm, MoI = jupiter.moment_of_inertia()
print(R_cm/1e5)
#print(MoI/(Mplanet*(R_cm)**2))
J = jupiter.get_gravity()
print(J)
t1 = time.time()
